...
//dan bisa access dari extend class atau subclass
 class Employee3 {
   private _empCode:string;  //kalao jadi private penulisan baku  _variable
 ...
 //constructor
  constructor(code:string,name:string) {
   ...
   //getter
     public get get_empName() { //buat func get nama mirip2 variable prvate yg akan direturn
   ...
   //setter
   public set set_empName(myempName:string) { //ini buat func set
 ...
 class SalesEmployee extends Employee3 {
    ...
    //constructor
    constructor(code:string,name:string,salary:number,grade:number) {
