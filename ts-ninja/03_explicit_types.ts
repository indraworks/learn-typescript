...
*/
//explicit types
let character:string;// diinisialisasi string 
let age :number;
let isLoggedIn:true;
...
let arrayMix :(string|number|boolean)[]=[];
//isi arryaMixnya
...
//type data object  
let myObj : object; //sbaiknya dinisialisasi kosong dulu 
                //empty objetc
//atau sprti ini 
let myobj2 :object;
myObj = {
